        ...
        <div className="flex justify-between items-center">
          <a href="#home" className="flex items-center gap-4">
            <div className="flex items-center gap-2">
               <img src="/logos/telkom.png" alt="Telkom University Logo" className="h-10 w-10 object-contain" />
               <img src="/logos/hmif.png" alt="HMIF Logo" className="h-10 w-10 object-contain" />
               <div className="h-8 w-px bg-white/20 mx-1 hidden sm:block"></div>
               <img src="/logos/kabinet.png" alt="Kabinet Astravia Logo" className="h-10 w-10 object-contain hidden sm:block" />
            </div>
          ...
          >
            <div className="px-4 pt-4 pb-8 space-y-2">
              ...
              <div className="flex items-center gap-4 justify-center py-4 border-b border-white/10 mb-4 sm:hidden">
                 <img src="/logos/kabinet.png" alt="Kabinet Astravia Logo" className="h-12 w-12 object-contain" />
